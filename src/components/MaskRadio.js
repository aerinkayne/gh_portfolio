        ...
        <div>
            ...
            <div className="maskContainerSection">
                ...
                <div className="maskedImageDisplay _4to3lg" style={{display: props.maskTheme==='even3' ? 'flex' : 'none'}}>
                    <img src="/images/negSpaceImages/mountain-view-golden-hour-photography-733168.jpg" />
            ...
            <p>This is an in-progress experiment using SASS mixins, functions and loops to generate class names for masking and framing images. It started, in part, simply as a way to become more familiar with functionalities available through SASS.</p>
            ...
            <div className="maskContainerSection">
                ...
                <div className="maskContainer _4to3">
                    <img src="/images/negSpaceImages/pexels-photo-247431Pixabay1000.jpeg" />
                    <div className="vertWideC_60 Lmask"></div>
                    <div className="vertWideC_60 Rmask"></div>
                    <div className="vertWideC_60 Lframe"></div>
                    <div className="vertWideC_60 Midframe"></div>
                ...
                <div className="maskContainer _4to3">
                    <img src="/images/negSpaceImages/trees-in-forest-during-sunset-247421.jpg" />
                    <div className="vertCol2_w3 col1"></div>
                    <div className="vertCol2_w3 col2"></div>
                    <div className="vertCol2_w3 frame1"></div>
                    <div className="vertCol2_w3 frame2"></div>
            ...
            <div className="maskContainerSection">
                <div className="maskContainer _1to1">
                    <img src="/images/negSpaceImages/nature-animal-wolf-wildernessPixabay.jpg" /> 
                    <div className="triangle down"></div> 
                </div>

                <div className="maskContainer  _1to1lg">
                    <img src="/images/negSpaceImages/pexels-photo-2131828QuangNguyenVinh650.jpeg" /> 
                    <div className="triangle up"></div>
                </div>

                <div className="maskContainer _1to1">
                    <img src="/images/negSpaceImages/silver-bordered-fritillary-butterfly-nature-orangePixabay.jpg" />
                    <div className="triangle down"></div>
                </div>
            </div>
            ...
            <div className="maskContainerSection">
                <div className="maskContainer _1to1sm">
                    <img className="circle" src="/images/negSpaceImages/earth-spaceJaymantri1000.jpg" />
                </div>

                <div className="maskContainer _1to1lg">
                    <img className="circle" src="/images/negSpaceImages/pexels-photo-2885320RobertoNickson.jpeg" />
                ...
                <div className="maskContainer _1to1sm">
                    <img className="circle" src="/images/negSpaceImages/pexels-photo-55787DonaldTong.jpeg" />
                </div>
            </div>
        </div>
    );
